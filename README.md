...
- <img width="612px" src=./Readme_Assets/unlit.png/>

### 0. Basic Lighting
- Path to relevant file: `Assets/Shaders/Stylized.shadergraph`
...
- Path to relevant file: `Assets/Shaders/Outline.shadergraph`
...
- Path to relevant file: `Assets/Shaders/OutlineWobble.shadergraph`
...
- Path to relevant file: `Assets/Shaders/FinalFilter.shadergraph`
...
## Challenges
- The current implementation is not efficient by any means, and there are lots of room for improvement such as:
- compressing every 3 greyscale tonal art maps into a single texture
